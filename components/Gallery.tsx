...
const Gallery: React.FC<GalleryProps> = ({ images }) => {
  ...
  // Set initial visible count to 6 (divisible by 2 and 3 for nice grids on all devices)
  ...
  return (
    <section id="galerija" className="py-20 md:py-32 bg-cream relative transition-colors duration-300">
      <div className="container mx-auto px-6 max-w-7xl">
        <FadeIn>
          <div className="text-center mb-16 md:mb-24 max-w-3xl mx-auto">
            ...
            <h2 className="font-serif text-4xl md:text-6xl text-olive-dark mb-4 md:mb-6">Galerija Narave</h2>
        ...
        {/* CSS Grid Layout - Stable and responsive */}
          ...
          <div className="relative w-full max-w-6xl h-[100vh] md:h-[90vh] flex items-center justify-center p-0 md:p-8 z-10">
            ...
            >
              ...
              <div className="mt-6 md:mt-8 text-center animate-in slide-in-from-bottom-4 duration-700 delay-100 max-w-2xl px-4">
                ...
                <h3 className="text-white/90 font-serif text-xl md:text-3xl tracking-wide mb-2 md:mb-3 leading-tight">
                  {images[selectedIndex].alt}
                </h3>
                {images[selectedIndex].description && (
                  <p className="text-white/60 font-light text-xs md:text-base leading-relaxed line-clamp-3 md:line-clamp-none">
                    {images[selectedIndex].description}
                  </p>
                )}
              </div>
