...
// Declare global variables provided by DynamicReactRenderer
declare const uploadImage: (key: string, file: File) => Promise<string>;
declare const savedImages: Record<string, string>;
    ...
    timeline: [
        {
            ...
            image: savedImages?.timeline_0 || "https://picsum.photos/seed/img1_deponija/1200/800",
        },
        {
            year: "2014",
            title: "Atlas Okolja",
            ...
            image: savedImages?.timeline_1 || "https://picsum.photos/seed/img2_ortofoto2014/1200/800",
        },
        {
            year: "Junij 2017",
            ...
            image: savedImages?.timeline_2 || "https://picsum.photos/seed/img3_junij2017/1200/800",
        },
        {
            year: "Junij 2017",
            ...
            image: savedImages?.timeline_3 || "https://picsum.photos/seed/img4_profili/1200/800",
        },
        {
            year: "Junij 2017",
            ...
            image: savedImages?.timeline_4 || "https://picsum.photos/seed/img5_profil1/1200/800",
            stats: {
                om: "2.6%",
                p2o5: "0.7",
                k2o: "7.9"
        ...
        },
        {
            ...
            image: savedImages?.timeline_5 || "https://picsum.photos/seed/img6_gerk2018/1200/800",
        ...
        },
        {
            ...
            image: savedImages?.timeline_6 || "https://picsum.photos/seed/img7_tractor_front/1200/800",
            videos: [
        ...
        },
        {
            ...
            image: savedImages?.timeline_7 || "https://picsum.photos/seed/img8_field_view/1200/800",
        },
        {
            year: "Sept 2018",
            ...
            image: savedImages?.timeline_8 || "https://picsum.photos/seed/img9_subsoiling/1200/800",
            videos: [
        ...
        },
        {
            ...
            image: savedImages?.timeline_9 || "https://picsum.photos/seed/img10_spraying/1200/800",
            videos: [
        ...
        },
        {
            ...
            image: savedImages?.timeline_10 || "https://picsum.photos/seed/img11_drone2019/1200/800",
            videos: [
        ...
        },
        {
            ...
            image: savedImages?.timeline_11 || "https://picsum.photos/seed/img12_man_grass/1200/800",
        },
        {
            year: "Maj 2019",
            title: "Potek Dela",
            ...
            image: savedImages?.timeline_12 || "https://picsum.photos/seed/img13_mowing_may/1200/800",
        },
        {
            year: "April 2020",
            ...
            image: savedImages?.timeline_13 || "https://picsum.photos/seed/img14_april2020/1200/800",
        },
        {
            year: "Junij 2020",
            title: "1. Košnja",
            ...
            image: savedImages?.timeline_14 || "https://picsum.photos/seed/img15_bales/1200/800",
        },
        {
            year: "Sept 2020",
            ...
            image: savedImages?.timeline_15 || "https://picsum.photos/seed/img16_drone2020/1200/800",
            videos: [
        ...
        },
        {
            ...
            image: savedImages?.timeline_16 || "https://picsum.photos/seed/img17_soil_shovel/1200/800",
        },
        {
            year: "Januar 2021",
            ...
            image: savedImages?.timeline_17 || "https://picsum.photos/seed/img18_primoz/1200/800",
        }
    ],
    finalResults: {
...
const TimelineItem: React.FC<TimelineItemProps> = ({ data, index, onImageUpdate }) => {
    ...
    const handleFileChange = async (event: ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            try {
                setUploading(true);
                const url = await uploadImage(`timeline_${index}`, file);
                onImageUpdate(url);
            } catch (error) {
                console.error('Image upload failed:', error);
                alert('Napaka pri nalaganju slike');
                    ...
                    <div className="absolute inset-0 bg-black/40 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center text-white">
                        {uploading ? (
                            <>
                                ...
                                <span className="text-sm font-semibold">Nalaganje...</span>
                            </>
                        ) : (
                            <>
